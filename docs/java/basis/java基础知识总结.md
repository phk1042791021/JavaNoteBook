...
![Java程序转变为机器代码的过程](./images/java程序转变为机器代码的过程.png ':size=49%')
...
![编译型语言和解释型语言](./images/编译型语言和解释型语言.png ':size=40%')
...
![](images/20210425151835918.png ':size=60% :class=imgCenter')
...
> ![](images/86735519.jpg.png ':size=80%')
...
![](images/desktopjava核心技术-重载.jpg ':size=80%')
...
![](images/20210422164544846.png ':size=90%')
...
![](./images/shallow&deep-copy.png ':size=75%')
...
![](images/Java%E5%BC%82%E5%B8%B8%E7%B1%BB%E5%B1%82%E6%AC%A1%E7%BB%93%E6%9E%84%E5%9B%BE.png ':size=80%')

<p style="font-size:13px;text-align:right">图片来自：https://simplesnippets.tech/exception-handling-in-java-part-1/</p>

![](images/Java%E5%BC%82%E5%B8%B8%E7%B1%BB%E5%B1%82%E6%AC%A1%E7%BB%93%E6%9E%84%E5%9B%BE2.png ':size=50%')
...
![check-exception](images/QQ20211230-111946@2x.png)
...
![IO-操作方式分类](images/IO-操作方式分类.png.jpeg)

按操作对象分类结构图：

![IO-操作对象分类](images/IO-操作对象分类.png.jpeg)
