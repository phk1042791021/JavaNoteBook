...
![图片](images/640-20220104205457372 ':size=80%%')
...
![图片](images/640-20220104205457330 ':size=60% :class=imgCenter')
...
![图片](images/640-20220104205553704 ':size=80% :class=imgCenter')

虽然仅仅使用多个 listNode 结构就可以组成链表，但是使用 `adlist.h/list` 结构来持有链表的话，操作起来会更加方便：

![图片](images/640-20220104205553703 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104205553824.png ':size=80% :class=imgCenter')
...
![图片](images/640-20220104205651381 ':size=80% :class=imgCenter')
