...
![图片](images/640-20220104204143867 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204143876 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204143877 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204143870 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204143863 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204159817 ':size=80% :class=imgCenter')

从上面的创建和插入的过程中可以看出，每一个节点的层数（level）是随机出来的，而且新插入一个节点并不会影响到其他节点的层数，因此，**插入操作只需要修改节点前后的指针，而不需要对多个节点都进行调整**，这就降低了插入操作的复杂度。

现在我们假设从我们刚才创建的这个结构中查找 23 这个不存在的数，那么查找路径会如下图：

![图片](images/640-20220104204159806 ':size=80% :class=imgCenter')
...
![图片](images/640-20220104204249097 ':size=80% :class=imgCenter')
...
1. [跳跃表 Skip List 的原理和实现（Java）](blog.csdn.net/DERRANTCM/article/details/79063312)
2. [【算法导论33】跳跃表（Skip list）原理与java实现](blog.csdn.net/brillianteagle/article/details/52206261)
...
8. [为啥 redis 使用跳表(skiplist)而不是使用 red-black？](https://www.zhihu.com/question/20202931)
