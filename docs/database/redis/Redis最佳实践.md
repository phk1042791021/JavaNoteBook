...
例如，原有的 key 为 user_book_123，则可以优化为 u_bk_123。
...
* ZSet: `zipList hashTable + skipTable`
...
![图片](images/640-20220105150330842)
...
![图片](images/640-20220105150358351)
...
![图片](images/640-20220105150358422)
...
![图片](images/640-20220105150358401)
...
![图片](images/640-20220105150416817)
...
![图片](images/640-20220105150416812)

如果你的业务写请求量很大，单个 Redis 实例已无法支撑这么大的写流量，那么此时你需要使用分片集群，分担写压力。

![图片](images/640-20220105150416816)
...
![图片](images/640-20220105150446267)
...
![图片](images/640-20220105150446261)
...
![图片](images/640-20220105150530510)我还把这些实践优化，按照「业务开发」和「运维」两个维度，进一步做了划分。
...
![图片](images/640-20220105150530463 ':size=60%')

如果你是 DBA 运维人员，你需要在资源规划、运维、监控、安全层面做到位，做到未雨绸缪。

![图片](images/640-20220105150530429 ':size=90%')
